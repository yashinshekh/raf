...
if __name__ == '__main__':
    ...
    driver.get("https://reebelo.com.au/collections/smartphones?sort=latest-release")
    ...
    for link in links:
        driver.get("https://reebelo.com.au"+link)
        ...
        try:
            ...
            for data in jsondata['props']['pageProps']['offers']:
                ...
                if ["https://reebelo.com.au"+link,title,brand,vendor,ram,sku,color,condition,storage,connectivity,simslot,price] not in alreadyscrapped:
                    alreadyscrapped.append(["https://reebelo.com.au"+link,title,brand,vendor,ram,sku,color,condition,storage,connectivity,simslot,price])
                    with open(filename,"a") as f:
                        writer = csv.writer(f)
                        writer.writerow([datetime.datetime.now().strftime("%Y-%m-%d (%H:%M)"),"https://reebelo.com.au"+link,title,sold,brand,vendor,ram,sku,color,condition,storage,connectivity,simslot,price,
                                         nz_hkd_rate,nz_aud_rate,nz_usd_rate,nz_eur_rate,aud_hkd_rate,aud_usd_rate,aud_eur_rate])
                        print([datetime.datetime.now().strftime("%Y-%m-%d (%H:%M)"),"https://reebelo.com.au"+link,title,sold,brand,vendor,ram,sku,color,condition,storage,connectivity,simslot,price,
                               nz_hkd_rate,nz_aud_rate,nz_usd_rate,nz_eur_rate,aud_hkd_rate,aud_usd_rate,aud_eur_rate])
